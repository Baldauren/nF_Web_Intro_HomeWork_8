        ...
        <div className="wrapper ">
          <div className="post__text">
            <span className="authors__name">
              ...
              />
              <span className="authors__name-span">Имя автора</span> в
              <span className="authors__name-span">Название темы</span> · 7 июля
            </span>
            <p className="post__title ">Заголовок поста</p>
            <p className="post__descr ">Описание поста</p>
